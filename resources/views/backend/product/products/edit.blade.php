            ...
            <div class="col-md-4">
                ...
                @if(get_setting('club_point'))
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="control-label" for="start_date">{{ translate('Set Point') }}</label>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="card">
                        <div class="card-header" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true">     
                            <span class="h6">{{ translate('Product Description') }} </span>
                    ...
                    <div class="card">
                        <div class="card-header collapsed" data-toggle="collapse" data-target="#collapsefeature" aria-expanded="false" aria-controls="collapseTwo">     
                            <span class="h6">Features</span>
                            <span class="accicon"><i class="fa fa-angle-down rotate-icon"></i></span>
                        </div>
                        <div id="collapsefeature" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                               <textarea class="aiz-text-editor" name="profeatures"><?php echo $product->profeatures;?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">     
                            <span class="h6">Key Specifications</span>
                            <span class="accicon"><i class="fa fa-angle-down rotate-icon"></i></span>
                        </div>
                        <div id="collapseTwo" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                               <textarea class="aiz-text-editor" name="keyspeci"><?php echo $product->keyspeci;?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false">
                            <span class="h6">Packaging</span>
                            <span class="accicon"><i class="fa fa-angle-down rotate-icon"></i></span>
                        </div>
                        <div id="collapseThree" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                 <textarea class="aiz-text-editor" name="packaging"><?php echo  $product->packaging;?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header collapsed" data-toggle="collapse" data-target="#collapsefour" aria-expanded="false">
                            <span class="h6">Direction to Use</span>
                            <span class="accicon"><i class="fa fa-angle-down rotate-icon"></i></span>
                        </div>
                        <div id="collapsefour" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                <textarea class="aiz-text-editor" name="directiontouse"><?php echo $product->directiontouse;?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapsefive" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                 <textarea class="aiz-text-editor" name="faqs"><?php echo  $product->faqs;?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header collapsed" data-toggle="collapse" data-target="#collapsesix" aria-expanded="false">
                            <span class="h6">Warranty</span>
                            <span class="accicon"><span class="aiz-side-nav-arrow rotate-icon"></span></span>
                        </div>
                        <div id="collapsesix" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                <textarea class="aiz-text-editor" name="warranty"><?php echo  $product->warranty;?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
