                    ...
                    <div class="card">
                     ...
                     <div class="card">
                        ...
                        <div id="collapsefeature" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                <textarea class="aiz-text-editor" name="profeatures"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                <textarea class="aiz-text-editor" name="keyspeci"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                 <textarea class="aiz-text-editor" name="packaging"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapsefour" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                 <textarea class="aiz-text-editor" name="directiontouse"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapsefive" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                 <textarea class="aiz-text-editor" name="faqs"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapsesix" class="collapse" data-parent="#accordionExample">
                            <div class="card-body">
                                 <textarea class="aiz-text-editor" name="warranty"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
