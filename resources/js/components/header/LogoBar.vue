    ...
    <div class="logobar">
            <div class="d-flex align-center">
                ...
                <div :class="['flex-grow-1 search-box', { open: openSearch }]">
                    ...
                    >
                        <v-row align="center" dense style="background: white;">
                            <v-col>
                                <v-text-field
...
import LanguageSwitchDialog from "../inc/LanguageSwitchDialog";
...
export default {
    ...
    computed: {
        ...
        ...mapGetters("app", ["appLogo", "appName", "allLanguages","userLanguageObj"]),
